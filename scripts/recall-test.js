...
const TEST_QUERIES = [
  {
    ...
    expectedTerms: ['order', 'shipping', 'waiting', 'arrived', 'delivery'],
  ...
  },
  {
    id: 'Q3',
    label: 'Upcoming',
    query: 'What is coming up for me this month?',
    expectedFiles: ['MEMORY.md'],
    expectedTerms: ['deadline', 'meeting', 'scheduled', 'reminder'],
    antiTerms: [],
    minChunks: 4,
    minRelevant: 3,
  },
  ...
  },
  {
    id: 'Q5',
    label: 'Health',
    query: 'How has my health tracking changed recently?',
    expectedFiles: ['MEMORY.md'],
    expectedTerms: ['health', 'weight', 'protocol', 'supplement'],
    antiTerms: [],
    minChunks: 6,
    minRelevant: 5,
  },
  {
    id: 'Q6',
    label: 'Strategy',
    query: 'What did I decide about my investment strategy?',
    expectedFiles: ['MEMORY.md'],
    expectedTerms: ['strategy', 'portfolio', 'position', 'framework'],
    antiTerms: [],
    minChunks: 6,
    minRelevant: 5,
  },

...
**[Structured Memory Engine v6.4.1](https://github.com/Bryptobricks/Structured-Memory-Engine)** is now the recommended search and recall backend. See [upgrade guide](docs/UPGRADE-v6.md) for what's new, and [v6.4.1 tuning guide](docs/TUNING-v6.4.1.md) for post-audit fixes. It replaces 3 of our 11 components with a unified engine that adds auto-recall, confidence scoring, entity graphs, and semantic embeddings — all local, zero API cost.
